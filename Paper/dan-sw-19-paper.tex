...
about because of Hemann et al.'s work on microKanren. Also, miniKanren
...
are indeed possible by using a Scheme interpreter written in miniKanren, thereby
...
The strategy \textbf{b}alanced \textbf{i}nterleaving DFS (\DFSbi{}) has an almost-fair \disj{} and unfair 
...
The next two benchmarks about generating quines are based on a similar test case in 
