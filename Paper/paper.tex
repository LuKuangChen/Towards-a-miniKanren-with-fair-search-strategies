...
Fig.~\ref{balanced-disj}. The helper \code{disj+} builds a balanced binary tree 
whose leaves are the goals and whose nodes are \code{disj2}, hence the name of 
this search strategy. The first argument 
to \code{disj+} is the goals. And the next two arguments accumulate goals in 
