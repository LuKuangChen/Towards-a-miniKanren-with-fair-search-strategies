...
chance to contribute to the answers. As an example, consider the following
...
\conde intuitively corresponds to \texttt{or} in logic. An unsuspicious beginner
would expect each letter to contribute equally to the result, as following. 
...
A subtlety arises when 
A subtlety in writing miniKanren programs with \conde expressions with many
clauses, such 
