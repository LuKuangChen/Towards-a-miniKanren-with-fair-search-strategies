...
case, a new thunk is constructed. 
The new thunk swapped two search spaces back before recursion. This is 
unnecessary for fairness. We do it such that answers are produced in a more 
natural order.
