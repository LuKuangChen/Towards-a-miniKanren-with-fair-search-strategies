...
% ---from here to the end of this section are materials for this section---


% Compare with Backtracking, Interleaving, and Terminating Monad Transformers
...
% Compare with The Algebra of Logic Programming by Seresall
...
should comes later.
%TODO KC: prefer an example from other literatures

%TODO KC: Should we use microKanren instead?
...
%iDFS biases toward left \texttt{conde} lines. So miniKanren programmers sometimes need to
%organize their \texttt{conde} lines carefully. We propose and implement two search strategies,
%breadth-first search (BFS) and balanced interleaving DFS (biDFS). With either of these
%search strategy, miniKanren becomes less sensitive to the order of \texttt{conde} lines. 
