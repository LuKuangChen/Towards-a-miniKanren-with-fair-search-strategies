...
%TODO 1. delete `, review=true' ; 2. delete this line .
\usepackage[
    type={CC},       
    modifier={by-sa},
    version={4.0},   
...
\maketitle
%\thispagestyle{empty}
%TODO uncomment the line above to be camera-ready
...
% of many unusual problems and their solutions in miniKanren.
...
%\citet{seres1999algebra}, a search strategy with fair \disj{} and fair 
%\conj{}. 
...
We would like to thank our reviewers, both known and anonymous, for their 
corrections and insightful suggestions.
