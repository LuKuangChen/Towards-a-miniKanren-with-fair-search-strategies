...
\NOTE[DPF]{Does this assume that we never use run*, since in fact, the paper does not
include and uses of run*.  Something should be mentioned around here.}
...
\NOTE[DPF]{Why does the pair? case precede the null? case? Is it simply more efficient? It shouldn't be}
...
place this anywhere in the conclusion. This may require some consultation with Weixi.}
