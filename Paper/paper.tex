...
\NOTE[MVC]{We need clear definitions of the following: fair, almost-fair, and unfair. Either use bullet points, or definition environment. Google ``latex math definition.''}
\NOTE[MVC]{A quick intro to miniKanren would be nice here. We should mention The Reasoned Schemer, 2nd and say DFSi is used there.}
\NOTE[MVC]{We should cite the monad paper in introduction.}
...
\NOTE[MVC]{A motivation is needed. Why do people want fairness?}
\NOTE[MVC]{\texttt{conj} fairness is not defined.}
...
\subsection{comparison with the BFS of  \citep{seres1999algebra}}
...
\NOTE[MVC]{This is way too much into Coq. What we want to say here is that
  for any number n and goal g, (run n g) our system generates the same result
as Seres' does.}
