...
DFS$_\textrm{i}$, the current search strategy, gives us much more lists of \texttt{a}s than 
lists of other letters. And some letters (e.g. lists of \texttt{c}) are rarely 
